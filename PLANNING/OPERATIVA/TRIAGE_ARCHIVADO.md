# TRIAGE ARCHIVADO - Selector minimo de tarea

> Este archivo ya no es autoridad de raiz del proyecto.
> La rutina minima vigente se ha absorbido en `MAPA_PROYECTO.md`.
